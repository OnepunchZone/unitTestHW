...
public class AccountServiceImplTest {
    ...
    void testGetAccounts() {
        ...
        when(accountDao.findAll()).thenReturn(List.of(account1, account2));
    ...
    void testCharge() {
        ...
        boolean result = accountServiceImpl.charge(1L, new BigDecimal(50));
    ...
    @Test
    void testChargeNotFountExc() {
        when(accountDao.findById(1L)).thenReturn(Optional.empty());

        AccountException resultExp = assertThrows(AccountException.class, () -> {
            accountServiceImpl.charge(1L, new BigDecimal("100.00"));
        });

        assertEquals("No source account", resultExp.getLocalizedMessage());
    }
}
